<template>
    <div class="banner sticky-top dark">
        ...
        <div class="column" style="width:100%;">
            ...
            <div class="row" style="margin-top:auto; gap:5px; align-items: center;">
                <button class="button-secondary h4 icon-text" style="padding:5px;height:auto">
                ...
                <span class="h4 secondary-text" style="margin-left:auto">
                        {{ abbreviateNumber(53252) }} play{{ 53252!=1?'s':'' }}
                        <span class="bi bi-dot"></span>
                        <router-link class="secondary-text hoverable" :to="'/discover'">
