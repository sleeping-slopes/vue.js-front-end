  ...
  <div class="column">
    ...
    <panel v-if="this.currentViewStyle==0">
      <template v-slot:content>
        <songContainer :type="'ul-list scroll-hidden'" :dynamicComponent="'songExtended'" :playlist="historyPlaylist"></songContainer>
      </template>
    </panel>
    <songContainer :type="'ul-grid'" :dynamicComponent="'songCard'" :playlist="historyPlaylist" v-else></songContainer>
  </div>
</template>
